...
/************************* PLL Parameters *************************************/
#if defined(STM32F40_41xxx) || defined(STM32F427_437xx) || defined(STM32F401xx) || defined(STM32F469_479xx)
 /* PLL_VCO = (HSE_VALUE or HSI_VALUE / PLL_M) * PLL_N */
 #define PLL_M      8
#elif defined(STM32F429_439xx)
 /* PLL_VCO = (HSE_VALUE or HSI_VALUE / PLL_M) * PLL_N */     /* HSE=25MHz */
 #define PLL_M      25
...
#ifdef BOOTLOADER
  /* Bootloader 设置 VTOR —— 对于 App，VTOR 由 App 自行设置 */
#ifdef VECT_TAB_SRAM
...
#endif
#else
  /* App 模式: SystemInit 不设置 VTOR，由 main() 自行设置 SCB->VTOR */
  /* 这样可以确保 VTOR 在 main 中显式设置为 0x08020000 */
#endif
}
